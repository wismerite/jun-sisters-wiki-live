module "tags" {
  source = "github.com/wismerite/jun-sisters-wiki-modules.git//metadata/tags?ref=v0.0.42"
}

module "vpc" {
  source = "github.com/wismerite/jun-sisters-wiki-modules.git//network/vpc?ref=v0.0.42"
...
module "k8s_cluster" {
  # depends on vpc, tags
  source = "github.com/wismerite/jun-sisters-wiki-modules.git//k8s/cluster?ref=v0.0.42"
...
module "db_cluster" {
  ...
  source = "github.com/wismerite/jun-sisters-wiki-modules.git//data-store?ref=v0.0.42"
...
# module "firewalls" {
#   # depends on vpc, k8s, tags
#   source = "github.com/wismerite/jun-sisters-wiki-modules.git//network/firewalls?ref=v0.0.42"
...
module "project" {
  ...
  source = "github.com/wismerite/jun-sisters-wiki-modules.git//metadata/project?ref=v0.0.42"
...
module "k8s_ingress" {
  source = "github.com/wismerite/jun-sisters-wiki-modules.git//k8s/cluster_objects/ingress?ref=v0.0.42"
  service_name = var.name_prefix
  service_fqdn = "wiki.jun-sisters.gay"
}

module "chart_nginx" {
  source = "github.com/wismerite/jun-sisters-wiki-modules.git//k8s/charts/nginx?ref=v0.0.42"
...
module "chart_wiki" {
  source = "github.com/wismerite/jun-sisters-wiki-modules.git//k8s/charts/wiki?ref=v0.0.42"
...
module "chart_cert_manager" {
  source = "github.com/wismerite/jun-sisters-wiki-modules.git//k8s/charts/cert-manager?ref=v0.0.42"
...
module "k8s_secret_db_pw" {
  source = "github.com/wismerite/jun-sisters-wiki-modules.git//k8s/cluster_objects/secrets?ref=v0.0.42"
